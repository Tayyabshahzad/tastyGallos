...
class OrderController extends Controller
{
    ...
    $data = '{"franchise_id":1,"note":null,"products":[{"id":8,"quantity":1,"extras":[2,1],"modifier":[{"id":3,"items":[4,5,6,7]}]}],"address":null,"is_pickup":true,"user_id":"14","sub_total":1595,"total":1595,"payment_method":"cash"}';
        $extraPrice = 0;
        $subTotal = 0;
        $discountAmount = 0;
        $total = 0;
