...
@section('content')
    <div class="container">
        <div class="row mb-6">
            <div class="col-lg-12">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <span class="text-muted">Extras Edit</span>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('admin.extras.update') }}" method="post" enctype="multipart/form-data"   id="addProductFrom">
                    <div class="card card-custom mb-4">
                        <input type="hidden" name="id" value="{{ $extra->id }}">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Update Extras</h3>
                            </div>
                                ...
                                <div class="card-toolbar">
                                    <span class="switch switch-danger switch-icon switch-sm">
                                        <span class="font-weight-bold">Status</span> <label class="ml-2">
                                            <input type="checkbox" value="active"     @if ($extra->status == 'active') checked="checked" @endif name="status">
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input type="text" required="" placeholder="Enter extras name" class="form-control"   name="name" value="{{ $extra->name }}">
                                </div>
                                <div class="col-lg-12 form-group">
                                    <label class="font-weight-bold">Price *</label>
                                    <input type="number"  min="0" max="2000" step="0.01" required="" placeholder="Enter extras price" class="form-control" name="price" value="{{ $extra->price }}">
