						...
						<div class="login-form login-signin">
							...
							<form class="form" method="POST"   action="{{ route('password.email') }}"  >
								...
								<div class="pb-13 pt-lg-0 pt-5">
                                    ...
                                    <br/>
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg mt-5"> Forgotten Password ? </h3>
                                ...
                                <div class="form-group">
                                    ...
                                    type="email" name="email" autocomplete="off"  placeholder="Enter your email" required value="{{ old('email')}}"
                                    />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								...
								<div class="pb-lg-0 pb-5">
                                    ...
                                    <a href="{{ route('login')}}" type="button" id=" " class="btn btn-light-primary  btn-square font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</a>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
