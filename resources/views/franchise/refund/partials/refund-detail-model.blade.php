<div class="modal fade bd-example-modal-lg" id="refund_order_detail" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="modal-footer">
                    <div>
                        <button type="button" class="btn btn-danger font-weight-bold  btn-square modalClose " data-dismiss="modal"
