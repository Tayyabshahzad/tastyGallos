...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title> Update Password | Tasty Gallos </title>
						...
						<div class="login-form login-signin">
                            ...
                            <form method="POST" action="{{ route('franchise.password.update') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="{{ $UserToken }}" name="encrypted">
                                    @error('email')
                                ...
                                <div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										<label class="font-size-h6 font-weight-bolder text-dark pt-5 mylabels">Re-enter password</label>
									</div>
									<input
